      ...
      <div className="min-h-screen bg-[var(--bg-primary)] text-[var(--fg-primary)] p-6 lg:p-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-10">
            ...
            <div className="bg-[var(--bg-secondary)] border border-[var(--border-color)] rounded-xl p-6 hover:border-orange-500/50 transition-colors">
              <div className="flex items-start justify-between mb-4">
                <h3 className="text-lg font-semibold text-[var(--fg-primary)]">Competencia Individual</h3>
                  ...
                  <div className="flex items-center justify-center mb-6">
                    <div className="relative w-48 h-48">
                      ...
                      <div className="absolute inset-0 flex flex-col items-center justify-center">
                        ...
                        <span className="text-[var(--fg-muted)] text-sm uppercase tracking-wider">Global</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-3">
                    {recentResults.map((result, idx) => (
                      <Link
                        ...
                        className="flex items-center justify-between p-3 bg-[var(--bg-tertiary)] rounded-lg hover:bg-[var(--bg-tertiary)] transition-colors"
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p className="text-[var(--fg-primary)] text-sm font-medium">
                              {result.date.toLocaleDateString('es-CL', { day: '2-digit', month: 'short', year: 'numeric' })}
                            </p>
                            <p className="text-[var(--fg-muted)] text-xs">{result.correctAnswers}/{result.totalQuestions} correctas</p>
                          </div>
                        </div>
  ...
  if (saving) {
    return (
      <div className="flex flex-col items-center justify-center h-screen bg-[var(--bg-primary)]">
        ...
        <p className="text-[var(--fg-primary)]">Guardando resultados...</p>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-[var(--bg-primary)] text-[var(--fg-primary)] p-8">
      <div className="max-w-4xl mx-auto">
        {/* Progress Bar */}
        <div className="bg-[var(--bg-secondary)] border border-[var(--border-color)] rounded-xl p-4 mb-6 flex items-center justify-between">
          <div className="w-48">
            <p className="text-sm text-[var(--fg-muted)]">Pregunta {currentIndex + 1} de 60</p>
        ...
        <div className="flex gap-3">
          <button 
            ...
            className="px-6 py-3 bg-[var(--bg-tertiary)] border border-[var(--border-color)] text-[var(--fg-primary)] rounded-lg font-medium hover:bg-[var(--bg-tertiary)] disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Anterior
          </button>
          ...
          {currentIndex < 59 ? (
            <button 
              ...
              className="flex-1 py-3 bg-emerald-600 text-[var(--fg-primary)] rounded-lg font-medium hover:bg-emerald-700 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              Siguiente
            </button>
          ) : (
