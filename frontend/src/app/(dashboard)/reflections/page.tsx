    ...
    <div className="min-h-screen bg-[var(--bg-primary)] p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-3xl font-bold text-[var(--fg-primary)] mb-2">Mis Reflexiones</h1>
            <p className="text-[var(--fg-muted)]">Documenta tu viaje de coaching y tus ideas.</p>
          </div>
          <button
        ...
        {reflections.length === 0 ? (
          <>
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <div className="bg-[var(--bg-secondary)] border border-[var(--border-color)] rounded-xl p-5">
                ...
                <h3 className="text-[var(--fg-primary)] font-semibold mb-2">¿Por qué reflexionar?</h3>
              ...
              <div className="bg-[var(--bg-secondary)] border border-[var(--border-color)] rounded-xl p-5">
                ...
                <h3 className="text-[var(--fg-primary)] font-semibold mb-2">Privacidad</h3>
                <p className="text-[var(--fg-muted)] text-sm">
          ...
          <div className="space-y-4">
            {reflections.map((r) => (
              <div key={r.id} className="bg-[var(--bg-secondary)] border border-[var(--border-color)] rounded-xl p-6">
                <h3 className="text-[var(--fg-primary)] font-semibold mb-2">{r.title}</h3>
                <p className="text-[var(--fg-muted)] text-sm mb-3 line-clamp-3">{r.content}</p>
        ...
        {showModal && (
          <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
            <div className="bg-[var(--bg-secondary)] border border-[var(--border-color)] rounded-2xl p-6 w-full max-w-lg">
              <h2 className="text-xl font-bold text-[var(--fg-primary)] mb-6">Nueva Reflexión</h2>
              
              <div className="space-y-4">
                <div>
                  <label className="block text-sm text-[var(--fg-muted)] mb-2">Título</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-sm text-[var(--fg-muted)] mb-2">Tu reflexión</label>
                  <textarea
