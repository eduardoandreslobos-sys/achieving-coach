...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://achievingcoach.com/terms",
  },
  robots: {
    index: true,
    follow: true,
      ...
      <main className="min-h-screen bg-white" role="main">
        <section className="bg-gradient-to-br from-blue-50 to-white py-16" aria-labelledby="terms-heading">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <h1 id="terms-heading" className="text-4xl md:text-5xl font-bold text-gray-900 tracking-tight text-center">
              Terms of Service
            </h1>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <article className="prose prose-lg max-w-none">
              ...
              <p className="text-gray-600 mb-6">
                By accessing or using AchievingCoach, you agree to be bound by these Terms of Service and all 
              ...
              <p className="text-gray-600 mb-6">
                AchievingCoach is a professional coaching platform that provides tools for coaches to manage 
                their practice, track client progress, conduct assessments, and deliver structured coaching 
                exercises. The platform serves both coaches and their clients (coachees).
              </p>
              ...
              <p className="text-gray-600 mb-6">
                Subscriptions are billed monthly or annually. You may cancel at any time, and your subscription 
              ...
              <p className="text-gray-600 mb-6">
                ...
                AchievingCoach and is protected by international copyright, trademark, and other intellectual 
                property laws. Your coaching content and client data remain your property.
              </p>
              ...
              <p className="text-gray-600 mb-6">
                AchievingCoach shall not be liable for any indirect, incidental, special, consequential, 
                or punitive damages resulting from your use of or inability to use the platform. Our total 
              ...
              <p className="text-gray-600 mb-6">
                ...
                of these Terms. Upon termination, your right to use the platform will cease immediately. 
              ...
              <p className="text-gray-600 mb-6">
                ...
                changes by posting an announcement on the platform or sending you an email. Your continued 
              ...
              <p className="text-gray-600 mb-6">
                ...
                in which AchievingCoach operates, without regard to conflict of law provisions.
              </p>
