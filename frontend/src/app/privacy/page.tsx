...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://achievingcoach.com/privacy",
  },
  robots: {
    index: true,
    follow: true,
      ...
      <main className="min-h-screen bg-white" role="main">
        <section className="bg-gradient-to-br from-blue-50 to-white py-16" aria-labelledby="privacy-heading">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <h1 id="privacy-heading" className="text-4xl md:text-5xl font-bold text-gray-900 tracking-tight text-center">
              Privacy Policy
            </h1>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <article className="prose prose-lg max-w-none">
              ...
              <p className="text-gray-600 mb-6">
                Welcome to AchievingCoach. We respect your privacy and are committed to protecting your personal data. 
                This privacy policy explains how we collect, use, disclose, and safeguard your information when you 
                use our coaching platform.
              </p>
              ...
              <p className="text-gray-600 mb-6">
                ...
                of data in transit and at rest, regular security assessments, and strict access controls.
              </p>
