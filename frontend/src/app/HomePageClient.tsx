    ...
    <SmoothScrollWrapper>
      ...
      <section className="py-20 px-6 bg-[var(--bg-secondary)]">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-[var(--fg-muted)] mb-10 max-w-2xl">
          ...
          <div className="grid lg:grid-cols-2 gap-6">
            ...
            <div className="bento-card p-6">
              ...
              <div className="flex flex-wrap gap-2 mb-6">
                <span className="px-3 py-1 bg-[var(--bg-tertiary)] border border-[var(--border-color)] rounded-full text-xs text-[var(--fg-muted)]">Escucha Activa</span>
                <span className="px-3 py-1 bg-[var(--bg-tertiary)] border border-[var(--border-color)] rounded-full text-xs text-[var(--fg-muted)]">Preguntas Poderosas</span>
                <span className="px-3 py-1 bg-[var(--bg-tertiary)] border border-[var(--border-color)] rounded-full text-xs text-[var(--fg-muted)]">Presencia</span>
              </div>
              <Link href="/coach/icf-simulator" className="text-[var(--accent-primary)] text-sm font-medium hover:text-[var(--accent-secondary)] flex items-center gap-1">
                Probar Simulador
                <ArrowRight className="w-4 h-4" />
              </Link>
            </div>
            ...
            <div className="bento-card p-6">
              <div className="flex items-start justify-between mb-6">
                <div>
                  ...
                  <h3 className="text-xl font-bold text-[var(--fg-primary)] mb-1">Plantillas Listas</h3>
                  <p className="text-[var(--fg-muted)] text-sm">Más de 10 estructuras de sesión y recursos preconstruidos para maximizar tu tiempo.</p>
                </div>
              </div>
              <div className="border-t border-[var(--border-color)] pt-4 mb-4">
                <h4 className="text-[var(--fg-primary)] font-semibold mb-1">12+ Herramientas</h4>
                <p className="text-[var(--fg-muted)] text-sm">Versiones digitales interactivas de los ejercicios clásicos de coaching.</p>
              </div>
              <div className="flex flex-wrap gap-2">
                {tools.map((tool, i) => (
                  <span key={i} className="px-3 py-1.5 bg-[var(--bg-tertiary)] border border-[var(--border-color)] rounded-lg text-xs text-[var(--fg-secondary)] flex items-center gap-1.5">
                    <span className="text-[var(--accent-primary)]">{tool.icon}</span>
                    {tool.name}
                  </span>
                ))}
              </div>
      ...
      <section className="py-20 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-[var(--accent-primary)] text-xs uppercase tracking-wider mb-4">INTELLIGENCE LAYER</p>
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="text-[var(--fg-primary)] font-semibold mb-1">Analítica de Progreso en Tiempo Real</h4>
                    <p className="text-[var(--fg-muted)] text-sm">Visualiza el crecimiento del cliente con gráficos dinámicos que capturan KPIs personalizados.</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="text-[var(--fg-primary)] font-semibold mb-1">Insights Generados por IA</h4>
                    <p className="text-[var(--fg-muted)] text-sm">Sugerencias sobre técnicas de preguntas y patrones lingüísticos basados en análisis de transcripciones.</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="text-[var(--fg-primary)] font-semibold mb-1">Reportes Finales y de Proceso</h4>
                    <p className="text-[var(--fg-muted)] text-sm">Genera informes de alto nivel automáticos entre sesiones para equipos de RRHH, corporativos o reflexión del cliente.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bento-card">
              <div className="flex items-center justify-between mb-6">
                <h4 className="text-[var(--fg-primary)] font-semibold">Velocidad de Crecimiento</h4>
                <span className="text-[var(--accent-primary)] text-sm">+24% último trimestre</span>
              </div>
              <div className="h-40 bg-[var(--bg-tertiary)] rounded-lg mb-6 flex items-end p-4 gap-2">
                {[30, 45, 35, 60, 50, 70, 65, 80, 75, 90].map((h, i) => (
                  <div key={i} className="flex-1 bg-emerald-500/50 rounded-t" style={{ height: `${h}%` }}></div>
                ))}
              </div>
              <div className="bg-[var(--bg-tertiary)] rounded-lg p-4">
                <div className="flex items-center gap-2 text-[var(--accent-primary)] text-xs mb-2">
      ...
      <section className="py-20 px-6 bg-[var(--bg-secondary)]">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="flex justify-center gap-8 mb-12">
            <div className="w-16 h-16 bg-[var(--bg-tertiary)] border border-[var(--border-color)] rounded-xl flex items-center justify-center btn-micro">
          ...
          <div className="flex justify-center gap-6 flex-wrap">
            <div className="flex items-center gap-2 px-4 py-2 bg-[var(--bg-tertiary)] border border-[var(--border-color)] rounded-lg">
              ...
              <span className="text-sm text-[var(--fg-secondary)]">Open API</span>
              <span className="text-xs text-[var(--fg-muted)]">v2.0 disponible</span>
            </div>
            <div className="flex items-center gap-2 px-4 py-2 bg-[var(--bg-tertiary)] border border-[var(--border-color)] rounded-lg">
              <Workflow className="w-4 h-4 text-violet-400" />
              <span className="text-sm text-[var(--fg-secondary)]">Workflows</span>
              <span className="text-xs text-[var(--fg-muted)]">automatización nativa</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="bento-card p-8">
              <h3 className="text-xl font-bold text-[var(--fg-primary)] mb-6">¿Por qué elegir nuestra plataforma profesional?</h3>
              <ul className="space-y-4">
                <li className="flex gap-3">
                  <CheckCircle className="w-5 h-5 text-[var(--accent-primary)] flex-shrink-0 mt-0.5" />
                  <div>
                    <span className="text-[var(--fg-primary)] font-medium">Sistema operativo completo</span>
                    <p className="text-[var(--fg-muted)] text-sm mt-1">Gestiona todo tu negocio de coaching ejecutivo desde una única plataforma profesional integrada.</p>
                  </div>
                </li>
                <li className="flex gap-3">
                  <CheckCircle className="w-5 h-5 text-[var(--accent-primary)] flex-shrink-0 mt-0.5" />
                  <div>
                    <span className="text-[var(--fg-primary)] font-medium">Metodologías probadas</span>
                    <p className="text-[var(--fg-muted)] text-sm mt-1">Implementa GROW, DISC, Rueda de la Vida y más de 10 herramientas de coaching ejecutivo validadas.</p>
                  </div>
                </li>
                <li className="flex gap-3">
                  <CheckCircle className="w-5 h-5 text-[var(--accent-primary)] flex-shrink-0 mt-0.5" />
                  <div>
                    <span className="text-[var(--fg-primary)] font-medium">Analítica avanzada</span>
                    <p className="text-[var(--fg-muted)] text-sm mt-1">Demuestra el ROI de tu coaching ejecutivo con reportes automáticos y métricas de impacto.</p>
                  </div>
                </li>
                <li className="flex gap-3">
                  <CheckCircle className="w-5 h-5 text-[var(--accent-primary)] flex-shrink-0 mt-0.5" />
                  <div>
                    <span className="text-[var(--fg-primary)] font-medium">Cumplimiento ICF</span>
                    <p className="text-[var(--fg-muted)] text-sm mt-1">Plataforma profesional alineada con las competencias de la International Coaching Federation.</p>
                  </div>
                </li>
              </ul>
            </div>
      ...
      <section className="py-20 px-6 bg-[var(--bg-secondary)]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-[var(--fg-muted)] max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bento-card">
              ...
              <h3 className="text-[var(--fg-primary)] font-semibold mb-2">Coaching Ejecutivo de Alto Impacto</h3>
            ...
            <div className="bento-card">
              ...
              <h3 className="text-[var(--fg-primary)] font-semibold mb-2">Gestión Profesional de Clientes</h3>
              <p className="text-[var(--fg-muted)] text-sm">
            ...
            <div className="bento-card">
              ...
              <h3 className="text-[var(--fg-primary)] font-semibold mb-2">Inteligencia Artificial para Coaches</h3>
              <p className="text-[var(--fg-muted)] text-sm">
            ...
            <div className="bento-card">
              ...
              <h3 className="text-[var(--fg-primary)] font-semibold mb-2">Seguimiento de Objetivos</h3>
              <p className="text-[var(--fg-muted)] text-sm">
            ...
            <div className="bento-card">
              ...
              <h3 className="text-[var(--fg-primary)] font-semibold mb-2">Agendamiento y Recordatorios</h3>
              <p className="text-[var(--fg-muted)] text-sm">
            ...
            <div className="bento-card">
              ...
              <h3 className="text-[var(--fg-primary)] font-semibold mb-2">Reportes para Stakeholders</h3>
              <p className="text-[var(--fg-muted)] text-sm">
      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <p className="text-[var(--accent-primary)] text-xs uppercase tracking-wider mb-4">PREGUNTAS FRECUENTES</p>
          ...
          <div className="space-y-4">
            <details className="bento-card group">
              <summary className="p-6 cursor-pointer list-none flex items-center justify-between">
                <h3 className="text-[var(--fg-primary)] font-semibold">¿Qué es AchievingCoach?</h3>
            ...
            <details className="bento-card group">
              <summary className="p-6 cursor-pointer list-none flex items-center justify-between">
                <h3 className="text-[var(--fg-primary)] font-semibold">¿Cuánto cuesta AchievingCoach?</h3>
                <span className="text-[var(--fg-muted)] group-open:rotate-180 transition-transform">▼</span>
              </summary>
              <div className="px-6 pb-6 text-[var(--fg-muted)]">
            ...
            <details className="bento-card group">
              <summary className="p-6 cursor-pointer list-none flex items-center justify-between">
                <h3 className="text-[var(--fg-primary)] font-semibold">¿Está alineado con las competencias ICF?</h3>
                <span className="text-[var(--fg-muted)] group-open:rotate-180 transition-transform">▼</span>
              </summary>
              <div className="px-6 pb-6 text-[var(--fg-muted)]">
            ...
            <details className="bento-card group">
              <summary className="p-6 cursor-pointer list-none flex items-center justify-between">
                <h3 className="text-[var(--fg-primary)] font-semibold">¿Qué herramientas de coaching incluye?</h3>
                <span className="text-[var(--fg-muted)] group-open:rotate-180 transition-transform">▼</span>
              </summary>
              <div className="px-6 pb-6 text-[var(--fg-muted)]">
            ...
            <details className="bento-card group">
              <summary className="p-6 cursor-pointer list-none flex items-center justify-between">
                <h3 className="text-[var(--fg-primary)] font-semibold">¿Es seguro para los datos de mis clientes?</h3>
                <span className="text-[var(--fg-muted)] group-open:rotate-180 transition-transform">▼</span>
              </summary>
              <div className="px-6 pb-6 text-[var(--fg-muted)]">
            ...
            <details className="bento-card group">
              <summary className="p-6 cursor-pointer list-none flex items-center justify-between">
                <h3 className="text-[var(--fg-primary)] font-semibold">¿Soporta múltiples idiomas?</h3>
                <span className="text-[var(--fg-muted)] group-open:rotate-180 transition-transform">▼</span>
              </summary>
              <div className="px-6 pb-6 text-[var(--fg-muted)]">
